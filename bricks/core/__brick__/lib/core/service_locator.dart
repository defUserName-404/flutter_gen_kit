...
class ServiceLocator {
  ...
  static Future<void> setup() async {
    ...
    _sl.registerLazySingleton<InternetConnection>(() => InternetConnection());

    // Core services
    _sl.registerLazySingleton<AppLogger>(() => AppLogger());
    _sl.registerLazySingleton<NetworkInfo>(() => NetworkInfoImpl(_sl()));
    _sl.registerLazySingleton<ApiClient>(() => ApiClient(_sl(), 'https://api.example.com')); // Replace with actual base URL
